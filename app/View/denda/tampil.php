                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="bookTable" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                <?php function formatToRupiah($amount) {
                                    return 'Rp ' . number_format($amount, 0, ',', '.');
                                    } $no = 1; foreach($model['denda'] as $denda) { ?>
                                <tr>
                                    <td><?= $no++; ?></td>
                                    <td><?= htmlspecialchars($denda['id_peminjam']) ?></td>
                                    <td><?= htmlspecialchars($denda['waktu_pengembalian']) ?></td>
                                    <td><?= htmlspecialchars(formatToRupiah($denda['denda'])) ?></td>
                                    <td>
                                        <div class="form-button-action">
                                        <a type="button" class="btn btn-link btn-danger" data-bs-toggle="tooltip" title="Remove" href="/denda/menghapus?id_denda=<?= $denda['id_denda'] ?>">
