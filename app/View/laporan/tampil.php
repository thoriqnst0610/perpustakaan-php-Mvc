                        ...
                        <table id="bookTable" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                <?php function formatToRupiah($amount) {
                                    ...
                                    } $no = 1; foreach($model['laporan'] as $laporan) { ?>
                                <tr>
                                    <td><?= $no++; ?></td>
                                    <td><?= htmlspecialchars($laporan['nama_anggota']) ?></td>
                                    <td><?= htmlspecialchars($laporan['alamat_anggota']) ?></td>
                                    <td><?= htmlspecialchars($laporan['nik']) ?></td>
                                    <td><?= htmlspecialchars($laporan['nama_buku']) ?></td>
                                    <td><?= htmlspecialchars($laporan['status_peminjaman']) ?></td>
                                    <td><?= htmlspecialchars(formatToRupiah($laporan['denda'])) ?></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
